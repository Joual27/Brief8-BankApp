...
?>
    ...
    <?php  require APPROOT."/views/incFile/userInfo.php"; ?>
    <div class="lg:w-[60%] ml-[25%] flex flex-col flex-1">
...
<div class="mt-20 -ml-[70px]">
  <h3 class="text-lg font-bold leading-6 font-medium text-gray-900">BANK STATISTICS</h3>
  ...
  <dl class="mt-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
    <div class="relative bg-white pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden w-[280px]">
      ...
      <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
        <p class="text-2xl font-semibold text-gray-900"><?php echo $data["totalClients"] ?></p>
    ...
    <div class="relative bg-white pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden w-[280px]">
      <dt>
        ...
        <p class="ml-16 text-xm font-medium text-gray-500 truncate">Total Accounts</p>
      </dt>
      <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
        <p class="text-2xl font-semibold text-gray-900"><?php echo $data["totalAccounts"] ?></p>
        <p class="ml-2 flex items-baseline text-sm font-semibold text-green-600">
    ...
    <div class="relative bg-white pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden w-[280px]">
      <dt>
        ...
        <p class="ml-16 text-xm font-medium text-gray-500 truncate">Total Transactions</p>
      </dt>
      <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
        <p class="text-2xl font-semibold text-gray-900"><?php echo $data["totalTransactions"] ?></p>
        <p class="ml-2 flex items-baseline text-sm font-semibold text-green-600">
          <!-- Heroicon name: solid/arrow-sm-up -->
          <svg class="self-center flex-shrink-0 h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <path fill-rule="evenodd" d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 7.414V15a1 1 0 11-2 0V7.414L6.707 9.707a1 1 0 01-1.414 0z" clip-rule="evenodd" />
    ...
    <div class="relative bg-white pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden w-[280px]">
      <dt>
        ...
        <p class="ml-16 text-xm font-medium text-gray-500 truncate">Overall Balance</p>
      </dt>
      <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
        <p class="text-2xl font-semibold text-gray-900"><?php echo $data["overallBalance"] ?></p>
        <p class="ml-2 flex items-baseline text-sm font-semibold text-green-600">
          <svg class="self-center flex-shrink-0 h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <path fill-rule="evenodd" d="M5.293 9.707a1 1 0 010-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 01-1.414 1.414L11 7.414V15a1 1 0 11-2 0V7.414L6.707 9.707a1 1 0 01-1.414 0z" clip-rule="evenodd" />
          </svg>
